...
Survey. Explain your logic in the experiment
"""


class Constants(BaseConstants):
    name_in_url = 'GameNov18_survey_text_logic'
    players_per_group = None

    # this is done only to count the number of questions
    # (assuming Russian and English versions have the same number)
    with open('GameNov18_intro/survey1_en.csv') as questions_file:
...
class Player(BasePlayer):
    ...
    def current_question(self):
        return self.session.vars['survey1_list'][self.round_number - 1]
